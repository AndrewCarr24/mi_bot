...
# Register dsRAG subclasses (BedrockTitanEmbedding)
...
def _load_kb():
    # NoReranker is baked into the persisted KB metadata at build time, so
    # no runtime swap needed (matches dsrag_kb.get_kb()).
