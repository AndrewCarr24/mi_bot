...
Usage:
    cd agent_fin
    python eval/run_eval.py                          # questions_financebench.csv
...
sys.path.insert(0, str(_HERE.parents[1]))  # agent_fin/
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "csv_path",
        nargs="?",
        default=str(EVAL_DIR / "questions_financebench.csv"),
        help="Input CSV (default: eval/questions_financebench.csv).",
    )
