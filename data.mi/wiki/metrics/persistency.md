...
> Persistency measures the percentage of insurance-in-force (IIF) that remains on a mortgage insurer's books after a twelve-month period. It is a primary determinant of future premium revenue, particularly for monthly-premium policies, and is highly sensitive to mortgage interest rates, home price appreciation, and refinancing activity. Persistency rates across the six MIs have been historically elevated since 2022 due to the high-interest-rate environment suppressing refinance volumes.

## What it is

Annual persistency is defined as the percentage of insurance-in-force (IIF) that remains in force from one year prior, reflecting the rate at which policies are retained rather than cancelled or paid off (MTG_10-K_2024-12-31). When a borrower refinances, sells the home, or pays down the loan to the point where mortgage insurance is no longer required (typically at 78% LTV under the Homeowners Protection Act, or under broader GSE cancellation guidelines), the policy is cancelled and the IIF is reduced (MTG_10-K_2024-12-31). Persistency is the complement of the run-off rate — the percentage of IIF that leaves the book over a given period.

For monthly-premium policies, which constitute the vast majority of new business (e.g., 98% of NMIH's NIW in 2024), higher persistency means more months of premium collection and thus higher lifetime revenue per policy (NMIH_10-K_2024-12-31). For single-premium policies, where the premium is collected upfront and earned over the estimated life, higher-than-expected persistency can reduce profitability because the policy remains in force longer than assumed at pricing (MTG_10-K_2024-12-31).

## Why it matters

Persistency is a critical sensitivity for MI revenue models. Because most premiums earned in any given year come from policies written in prior years, even small changes in persistency compound into meaningful revenue impacts. A decline in persistency — triggered by a wave of refinancing — can rapidly erode the IIF base and reduce future premium streams. Conversely, elevated persistency, while supporting near-term revenue, can increase the incidence of claims on older books and, for single-premium policies, compress returns on business that was priced for a shorter expected life (NMIH_10-K_2024-12-31).
