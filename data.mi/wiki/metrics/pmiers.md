...
The original aligned PMIERs were drafted in 2014 (with the FHFA Overview giving existing insurers up to two years to achieve full compliance with the financial requirements) and took effect in 2015 (INDUSTRY_PMIERS_OVERVIEW_FHFA). The revised PMIERs 2.0 framework was published September 27, 2018 and took effect immediately for new applicants and on March 31, 2019 for existing approved insurers — i.e., roughly six months of lead time, not the two-year transition period of the original framework (INDUSTRY_PMIERS_2.0_BASE). The 2019 version established the available-assets vs. required-assets framework that remains in place today, along with the operational scorecard, quality control requirements, and reporting obligations.
