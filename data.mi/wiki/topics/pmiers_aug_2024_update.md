# August 2024 PMIERs Update

> In August 2024, the GSEs issued a significant update to the Private Mortgage Insurer Eligibility Requirements (PMIERs) that, for the first time, introduces deductions to available assets for investment portfolio risk. The update, formalized in PMIERs Guidance 2024-01, imposes new haircuts, concentration limits, and exclusions on the types of assets insurers can count toward their available assets. The changes are being phased in over 24 months (March 2025 through September 2026), giving insurers time to adjust their portfolios. For the six MIs, the impact is modest — MGIC estimated a ~1% reduction to available assets if fully effective at year-end 2024 — but the structural shift toward risk-sensitive capital treatment is significant.

## What it is

The August 2024 PMIERs update (Guidance 2024-01) amends Section 703 of the PMIERs to introduce enhanced available assets requirements. Previously, the PMIERs framework set financial strength standards through the *required assets* side — i.e., how much capital an insurer must hold based on the risk profile of its insured loans — but did not require insurers to hold additional assets to cover the risk that the *available assets themselves* might lose value. The 2024 update addresses this gap by applying haircuts, exclusions, and concentration limits to the investment portfolio side of the balance sheet (INDUSTRY_PMIERS_GUIDANCE_2024-01).
...
This update represents a structural tightening of the PMIERs framework. For the first time, the GSEs are explicitly requiring insurers to hold capital against investment portfolio risk, not just insurance underwriting risk. This has several implications:
...
The aligned PMIERs framework was originally drafted in 2014 (INDUSTRY_PMIERS_OVERVIEW_FHFA) and took effect in 2015, with PMIERs 2.0 effective March 31, 2019 for existing approved insurers (INDUSTRY_PMIERS_2.0_BASE). The August 2024 update is the most significant change to the available assets definition since the framework's inception. Prior to this update, the PMIERs focused exclusively on the risk-based required asset side — i.e., how much capital an insurer needs based on its insured loan book. The 2024 update introduces the concept that the assets themselves carry risk that must be explicitly accounted for.

The COVID-19 pandemic prompted temporary relief measures (2021 Guidance) that reduced required asset amounts for non-performing loans in forbearance. Guidance 2024-2 sunsets those relief measures now that the national emergency has ended, requiring standard risk-based factors for any remaining COVID-19-related delinquencies (INDUSTRY_PMIERS_GUIDANCE_2024-02).
