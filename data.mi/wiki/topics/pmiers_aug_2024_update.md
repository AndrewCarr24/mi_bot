...
The PMIERs framework was originally established in 2008 and has been updated periodically. The 2024 update is the most significant change to the available assets definition since the framework's inception. Prior to this update, the PMIERs focused exclusively on the risk-based required asset side — i.e., how much capital an insurer needs based on its insured loan book. The 2024 update introduces the concept that the assets themselves carry risk that must be explicitly accounted for.
